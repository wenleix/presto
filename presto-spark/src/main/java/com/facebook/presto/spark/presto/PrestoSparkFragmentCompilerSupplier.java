...
public class PrestoSparkFragmentCompilerSupplier
        implements Supplier<SparkFragmentCompiler>, Serializable
{
    private final PrestoConfiguration prestoConfiguration;

    public PrestoSparkFragmentCompilerSupplier(PrestoConfiguration prestoConfiguration)
    {
    ...
    {
        return new PrestoSparkFragmentCompiler(prestoConfiguration);
    }
}
