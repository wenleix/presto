...
public class HiveWriterFactory
{
            ...
            HiveWriterStats hiveWriterStats)
    {
        ...
        if (immutablePartitions) {
            checkArgument(
                    insertExistingPartitionsBehavior == InsertExistingPartitionsBehavior.ERROR ||
                            insertExistingPartitionsBehavior == InsertExistingPartitionsBehavior.OVERWRITE,
                    format("Unsupported insert existing partition behavior %s with immutable partitions", insertExistingPartitionsBehavior));
        }
        else {
            checkArgument(
                    insertExistingPartitionsBehavior == InsertExistingPartitionsBehavior.APPEND ||
                            insertExistingPartitionsBehavior == InsertExistingPartitionsBehavior.OVERWRITE,
                    format("Unsupported insert existing partition behavior %s with mutable partitions", insertExistingPartitionsBehavior));
        }
