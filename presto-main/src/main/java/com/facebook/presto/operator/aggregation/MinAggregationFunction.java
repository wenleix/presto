...
import static com.facebook.presto.operator.aggregation.MinMaxHelper.minCombineStateWithState;
import static com.facebook.presto.operator.aggregation.MinMaxHelper.minCombineStateWithValue;
...
public class MinAggregationFunction
{
    ...
    {
        minCombineStateWithValue(type, state, block, position);
    }
    ...
    {
        minCombineStateWithState(type, state, otherState);
    }
