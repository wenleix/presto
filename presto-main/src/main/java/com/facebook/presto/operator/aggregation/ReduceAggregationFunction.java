        ...
        extends SqlAggregationFunction
{
    ...
    private InternalAggregationFunction generateAggregation(Type type)
    {
        ...
        AggregationMetadata metadata = new AggregationMetadata(
                ...
                inputMethodHandle.asType(
                        inputMethodHandle.type()
                                .changeParameterType(3, inputType.getJavaType())),
                combineMethodHandle,
                outputMethodHandle,
                ReduceAggregationState.class,
                stateSerializer,
        ...
        return new InternalAggregationFunction(getSignature().getName(), inputTypes, stateType, outputType, true, false, factory);
    }
            ...
            BinaryFunctionInterface mergeValue)
    {
        ...
        try {
            newStateValue = mergeValue.apply(inputValue, currentStateValue);
        }
