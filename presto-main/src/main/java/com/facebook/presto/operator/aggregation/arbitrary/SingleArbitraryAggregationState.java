...
public class SingleArbitraryAggregationState
        implements ArbitraryAggregationState
{
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(SingleArbitraryAggregationState.class).instanceSize();
