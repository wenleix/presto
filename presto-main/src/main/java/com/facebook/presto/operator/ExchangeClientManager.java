...
public class ExchangeClientManager
{
    ...
    synchronized public ExchangeClient createExchangeClient(LocalMemoryContext systemMemoryContext)
    {
    ...
    synchronized public List<ExchangeClient> getExchangeClients()
    {
