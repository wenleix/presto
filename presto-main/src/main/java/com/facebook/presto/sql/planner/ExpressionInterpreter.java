    ...
    public static Object invoke(ConnectorSession session, ScalarFunctionImplementation function, List<Object> argumentValues)
    {
        ...
        try {
            ...
            for (int i = 0; i < argumentValues.size(); i++) {
                ...
                if (function.getLambdaInterface().containsKey(i) && !MethodHandle.class.equals(function.getLambdaInterface().get(i))) {
                    argument = asInterfaceInstance(function.getLambdaInterface().get(i), (MethodHandle) argument);
                }
