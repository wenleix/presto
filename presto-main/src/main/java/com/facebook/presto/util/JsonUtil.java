...
public final class JsonUtil
{
    ...
    {
        void parseAndAppendBlock(JsonParser parser, BlockBuilder blockBuilder)
                throws IOException;
            ...
            implements JsonToBlockAppender
    {
        ...
        @Override
        public void parseAndAppendBlock(JsonParser parser, BlockBuilder blockBuilder)
                throws IOException
        {
            ...
            while (parser.nextToken() != JsonToken.END_ARRAY) {
                elementAppender.parseAndAppendBlock(parser, entryBuider);
            }
                ...
                implements JsonToBlockAppender
    {
                ...
                throws IOException
        {
            ...
            while (parser.nextValue() != JsonToken.END_OBJECT) {
                ...
                valueBlockAppender.parseAndAppendBlock(parser, blockBuilder);
            }
            blockBuilder.closeEntry();
        }
    }
