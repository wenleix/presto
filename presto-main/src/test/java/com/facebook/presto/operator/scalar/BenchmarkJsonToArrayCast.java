...
public class BenchmarkJsonToArrayCast
{
    ...
    {
        //        @Param({"10000", "100000000", "10000000000000000"})
        @Param({"100000000"})
        private long valueBound = 10000;
        ...
        public void setup()
        {
            ...
            List<RowExpression> projections = ImmutableList.of(
                    new CallExpression(signature, new ArrayType(elementType), ImmutableList.of(
                            field(0, JSON))));
            ...
            page = new Page(createChannel(POSITIONS, ARRAY_SIZE, valueBound));
        }

        private static Block createChannel(int positionCount, int mapSize, long valueBound)
        {
            ...
            for (int position = 0; position < positionCount; position++) {
                ...
                for (int i = 0; i < mapSize; i++) {
                    ...
                    String value = Long.toString(ThreadLocalRandom.current().nextLong(valueBound));
